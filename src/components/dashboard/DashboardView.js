  ...
  return (
    <div className="container-fluid d-flex flex-column align-items-center justify-content-center min-vh-100 bg-white p-3 position-relative">
      <div className="d-flex flex-wrap justify-content-center gap-2">
            <button
              className="btn btn-sm btn-outline-secondary rounded-3 px-3 py-2 d-flex align-items-center justify-content-center"
            ...
            <button
              className="btn btn-sm btn-outline-primary rounded-3 px-3 py-2 d-flex align-items-center justify-content-center"
            ...
            <button
              className="btn btn-sm btn-outline-info rounded-3 px-3 py-2 d-flex align-items-center justify-content-center"
            ...
            <button
              className="btn btn-sm btn-outline-danger rounded-3 px-3 py-2 d-flex align-items-center justify-content-center"
      ...
      <div className="row w-100 justify-content-center align-items-center flex-grow-1">
        ...
        <div className="col-lg-6 col-md-8 p-4 text-center"> 
          <h1 className="display-4 fw-bold mb-4" style={{ color: '#333' }}>Selamat Datang {userName}</h1>
