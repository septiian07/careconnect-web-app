  ...
  return (
    <main className="bg-light min-vh-100 w-100 d-flex flex-column align-items-center px-3" style={{ backgroundColor: '#fffdf5' }}>
      <div className="container-fluid position-relative" style={{ maxWidth: '1920px' }}>
        ...
        {/* Page Title */}
        <h1 className="fw-bold text-dark text-center mt-4 mb-4" style={{ fontSize: '60px', fontFamily: "'Poppins', sans-serif", color: '#2f2f3e', marginTop: '160px' }}>
          Daftar Dokter
        </h1>

        {/* Search Bar */}
        <div className="position-relative mx-auto mb-5" style={{ maxWidth: '700px' }}>
          <div className="input-group input-group-lg shadow" style={{ borderRadius: '25px', border: '3px solid #37c8b3', backgroundColor: '#fffdf5' }}>
            <span className="input-group-text bg-transparent border-0" id="search-icon">
              <FaSearch className="text-info" style={{ fontSize: '34px', color: '#37c8b3' }} />
            </span>
            <input
              type="text"
              ...
              disabled={loading}
              style={{ height: '60px', paddingLeft: '20px', paddingRight: '1.5rem', fontSize: '35px', fontWeight: 'lighter', color: '#2e2e2e99', fontFamily: "'Poppins', sans-serif", boxShadow: 'none' }}
            />
          </div>
        </div>
          ...
          <div className="row row-cols-1 g-4 justify-content-center" style={{ maxWidth: '1800px', margin: '0 auto' }}> 
            {doctors.length === 0 ? (
              ...
              doctors.map((doctor, index) => (
                <div key={doctor.doctor_id} className="col-12 col-md-8 col-lg-6 mb-4"> 
                  <div className="card h-100 border rounded-lg shadow-sm" style={{ background: '#fff', padding: '20px' }}> 
                    <div className="card-body d-flex align-items-center justify-content-between p-0" style={{ minHeight: '100px' }}>

                      {/* Doctor Info */}
                      <div className="d-flex flex-column flex-grow-1 me-4">
                        <h2 className="fw-bold text-dark mb-1" style={{ fontSize: '32px', fontFamily: "'Poppins', sans-serif", color: '#2e2e2e' }}>
                          {doctor.doctor_name}
                        </h2>
                        <p className="fw-semibold text-muted mb-0" style={{ fontSize: '24px', fontFamily: "'Poppins', sans-serif", color: '#2e2e2e80', marginTop: '4px' }}>
                          {doctor.specialist}
                        </p>
                      </div>
                      ...
                      <div className="d-flex align-items-center flex-shrink-0">
                        <button
                          ...
                          style={{
                            width: '187px', height: '76px', backgroundColor: '#37c8b3', color: '#fffdf5',
